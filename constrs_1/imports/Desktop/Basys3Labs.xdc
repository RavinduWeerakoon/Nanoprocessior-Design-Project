...
#set_property PACKAGE_PIN W18 [get_ports {led[4]}]
	#et_property IOSTANDARD LVCMOS33 [get_ports {led[4]}]
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {Output_7seg[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Output_7seg[0]}]
set_property PACKAGE_PIN W6 [get_ports {Output_7seg[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Output_7seg[1]}]
set_property PACKAGE_PIN U8 [get_ports {Output_7seg[2]}]
...
set_property PACKAGE_PIN U5 [get_ports {Output_7seg[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Output_7seg[4]}]
set_property PACKAGE_PIN V5 [get_ports {Output_7seg[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Output_7seg[5]}]
set_property PACKAGE_PIN U7 [get_ports {Output_7seg[6]}]
